          ...
          >
            ...
            <div className="flex justify-end mt-2">
              <button
                ...
                className="bg-red-500 hover:bg-red-600 text-white text-sm font-medium px-2 py-1 rounded"
              >
                🗑️
              </button>
            </div>
      ...
      {chats.map((chat) => {
        ...
        return (
          ...
          >
            ...
            {/* เวลา: แสดงเฉพาะหน้าจอ sm ขึ้นไป */}
